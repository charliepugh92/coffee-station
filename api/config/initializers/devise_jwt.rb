Devise::JWT.configure do |config|
  # Single source of truth for the JWT secret. Falls back to
  # Rails.application.secret_key_base (the method, not the credentials entry) so
  # test/CI runs work without config/master.key.
